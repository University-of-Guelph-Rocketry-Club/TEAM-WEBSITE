...
export default function Home() {
  return <div className="club-home">
    <Hero />
    <section className="project-preview wrap">
      ...
      <div className="project-columns">
        ...
        <article><span className="project-category">Space systems</span><h3>CubeSat</h3><p>A small satellite project exploring onboard computing and machine learning in space.</p><Link to="/projects#cubesat">Explore the satellite</Link></article>
        <article><span className="project-category">Propulsion</span><h3>Hybrid engine</h3><p>Student-designed propulsion, from motor design and simulation to test stand development.</p><Link to="/projects#propulsion">Explore the engine</Link></article>
      </div>
    </section>
