...
export default function Home() {
  return <div className="club-home">
    ...
    <Reveal as="section" className="club-invitation"><div className="wrap invitation-layout"><h2>New to this?<br />Come give it a go!</h2><div><p>Write code, design a circuit, help build the rocket, or get us to competition with a budget and sponsors</p><p>Never done it before? That’s fine! Students from every Guelph program are welcome</p><Link className="club-button red" to="/join">I’m interested!</Link></div></div></Reveal>
