...
export default function Home() {
  return <div className="club-home">
    ...
    <section className="club-invitation"><div className="wrap invitation-layout"><h2>You don’t need to<br />be a rocket scientist</h2><div><p>Bring a question, some curiosity, or something you want to make — our teams work on software, electronics, rocketry, and everything that keeps the club moving</p><p>No experience needed, and every University of Guelph student is welcome</p><Link className="club-button red" to="/join">Find your team</Link></div></div></section>
