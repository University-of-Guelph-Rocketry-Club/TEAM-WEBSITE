const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'Building a miniature satellite for land surveying and remote sensing applications. Demonstrating space systems engineering capabilities.',
      status: 'Research Phase',
      category: 'Space Systems',
      technologies: ['Satellite Design', 'Remote Sensing', 'Communications', 'Orbital Mechanics'],
      timeline: '2025-2028',
